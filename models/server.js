...
class Server {
  constructor() {
    ...
    this.paths = {
            ...
            perfil:'/api/perfil',
            usuario:'/api/usuario',
            perfilsubmenu:'/api/perfilsubmenu',
            auth: '/api/auth',
  ...
  routes() {
    this.app.use(this.paths.menu, require('../routes/menus'));
    this.app.use(this.paths.submenu, require('../routes/submenus'));
    this.app.use(this.paths.perfil, require('../routes/perfiles'));
    this.app.use(this.paths.usuario, require('../routes/usuarios'));
    this.app.use(this.paths.perfilsubmenu, require('../routes/perfilsubmenus'));
